# Štěstí Naproti — Psychoterapeutická webová appka
...
### Hosting souborů
- **Primární:** GitHub Pages (repozitář: https://github.com/bobrerichacz/stesti_naproti_app)
- **GitHub Pages URL:** https://bobrerichacz.github.io/stesti_naproti_app/
...
## Kategorie obsahu (11 datových typů)
...
- "schemas": Ke každému mikročlánku je přiřazeno 5 schemat dle priority s váhami 5, 4, 3, 2, 1. Se schematy bude pracovat doporučování obsahu.
...
Platí pro mikročlánky, cvičení, inspirace a podnětné otázky. Položky těchto typů obsahu mají v json pole "schemas" s 5 schematy seřazenými podle priority. Prvnímu přiřaď váhu 5, poslednímu pátému váhu 1.
...
Odsud dál Bob nerevidoval toto readme.
...
| Soubor | Účel |
|--------|------|
| `stesti_admin.html` | Admin nástroj — standalone HTML, otevřít v prohlížeči |
| `README.md` | Tento dokument |

### GitHub Pages repozitář
```
https://github.com/bobrerichacz/stesti_naproti_app/
